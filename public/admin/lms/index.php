        ...
        <div class="card">
            ...
            <div class="card-body">
                <div style="text-align: center; padding: 3rem;">
                    ...
                    <h3 style="color: #6b7280;">LMS</h3>
                    <p style="color: #9ca3af;">This feature is under development. You'll be able to manage courses and learning materials here soon.</p>
                </div>
            </div>
        </div>
    </div>
