...
<div class="main-content">
    ...
    <div class="content-area">
        ...
        <div style="margin-bottom: 2rem;">
            ...
            <p style="color: #6b7280;">Manage all subjects</p>
        </div>
        
        <!-- Main Content -->
        <div class="card">
            <div class="card-header">
                <strong>Subjects Management</strong>
            </div>
            <div class="card-body">
                <p class="text-center" style="padding: 3rem; color: #6b7280;">
                    <i class="fas fa-book" style="font-size: 3rem; margin-bottom: 1rem; display: block; opacity: 0.3;"></i>
