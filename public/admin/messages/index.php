    ...
    <div class="content-area">
        <div class="page-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
            <div>
                ...
                <p style="color: #6b7280; margin: 0.5rem 0 0 0;">Your inbox and communications</p>
            </div>
            ...
            <div class="card-body">
                <?php if (empty($messages)): ?>
                    <div style="text-align: center; padding: 3rem;">
                        ...
                        <h3 style="color: #6b7280; margin-bottom: 0.5rem;">No Messages</h3>
                        <p style="color: #9ca3af; margin-bottom: 1.5rem;">You haven't received any messages yet</p>
                    </div>
                <?php else: ?>
                            ...
                            <tbody>
                                <?php foreach ($messages as $message): ?>
                                    <tr style="<?php echo !$message['is_read'] ? 'font-weight: bold; background-color: #f9fafb;' : ''; ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo BASE_URL; ?>public/admin/messages/view.php?id=<?php echo $message['id']; ?>" 
