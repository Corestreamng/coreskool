...
<div class="main-content">
    ...
    <div class="content-area">
        <div class="page-header" style="margin-bottom: 2rem;">
            <h2>My Messages</h2>
            <p style="color: #6b7280;">View messages from school administration and teachers</p>
        </div>
                            ...
                            <tbody>
                                <?php foreach ($messages as $message): ?>
                                    <tr style="<?php echo !$message['is_read'] ? 'font-weight: bold; background-color: #f9fafb;' : ''; ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo BASE_URL; ?>public/student/messages/view.php?id=<?php echo $message['id']; ?>" 
